                ...
                Container(width: MediaQuery.of(context).size.width/3,
                  child: Column(
                    ...
                    children: <Widget>[
                      Icon(Icons.power,
                        size: 40, color: Colors.lightGreen,),
                      Text("Nombre d'utilisateurs raccordés", textAlign: TextAlign.center,
                        style: TextStyle(
                          fontSize: 15,fontWeight: FontWeight.w700,color: Colors.black54,
                        ),
                      ),
                ...
                Container(width: MediaQuery.of(context).size.width/3,
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text('Puissance délivrée', textAlign: TextAlign.center,
                        style: TextStyle(
                          fontSize: 15,fontWeight: FontWeight.w700,color: Colors.black54,
                        ),
                      ),
